...
while Iteration<Max_iteration+1
    ...
    optimumX=Best_flame_pos;
    set(handles.text15,'string',optimumX);
    
    Iteration=Iteration+1; 
end
valX=Best_flame_pos;%valX=valX.';
valY=Best_flame_score;
assignin('base','MFO_valX',Best_flame_pos)
assignin('base','MFO_valY',Best_flame_score)
    z=[exetym results{5,1} valY valX];
    filename='Book1.xlsx';
    xlswrite(filename,z,'B6:C6:D6:H6');
end
