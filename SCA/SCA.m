...
while t<=Max_iteration
    ...
    optimumX=Destination_position;
    set(handles.text15,'string',optimumX);
    
    % Increase the iteration counter
    t=t+1;
end
valX=Destination_position;%valX=valX.';
valY=Destination_fitness;
assignin('base','SCA_valX',Destination_position)
assignin('base','SCA_valY',Destination_fitness)
    
    z=[exetym results{6,1} valY valX];
    filename='Book1.xlsx';
    xlswrite(filename,z,'B7:C7:D7:H7');
end